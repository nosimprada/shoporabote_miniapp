    ...
    return (
        <div>
            ...
            {userAgreementData.sections.map((section, index) => (
                ...
                <span className="badge rounded-pill mb-2 d-inline-block fs-6 fw-bold" style={{backgroundColor: "var(--tg-theme-button-color)", color: "var(--tg-theme-button-text-color)", padding: "8px 0px"}}>{section.heading}</span>
